//api key: LwcWtXkcanrsF730hMyEH07gNtwq7h5H
...
const send_api_request = async ()=>{
	...
	let response = await fetch(`https://api.giphy.com/v1/gifs/search?api_key=LwcWtXkcanrsF730hMyEH07gNtwq7h5H&q=${user_input}`)
